...
/// recent songs. The tuner is the most prominent action on the screen and the
/// only orange surface, which is what keeps the accent meaningful
/// (DESIGN.md §7).
